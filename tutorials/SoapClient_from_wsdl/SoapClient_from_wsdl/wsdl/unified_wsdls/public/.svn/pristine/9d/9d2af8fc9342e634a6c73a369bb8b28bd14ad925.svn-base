...
.page {
	border-bottom: 3px dotted #0063BE;
	margin: 0;
...
<xsl:template name="title.render">
	<div id="header" style="height:4em; line-height:8em;">
	     <h1>
	     	<table>
	     		<tr valign="middle">
	     			<td><a href="http://www.onvif.org"><img align="left" src="http://www.onvif.org/logo.gif" style="border-width: 0px;" alt="ONVIF" height="60" /></a></td> 
